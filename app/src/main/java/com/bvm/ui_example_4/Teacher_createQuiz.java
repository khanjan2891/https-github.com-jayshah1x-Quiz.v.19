...
public class Teacher_createQuiz extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add = (View) findViewById(R.id.add_quiz);
        del = (View) findViewById(R.id.del_layout);
        rootView = (ViewGroup) findViewById(R.id.quiz);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.nav_assignment:
                Intent intent = new Intent(Teacher_createQuiz.this, Assignment.class);
                startActivity(intent);
                break;
            case R.id.nav_subject:
                Intent intent2 = new Intent(Teacher_createQuiz.this, Third.class);
