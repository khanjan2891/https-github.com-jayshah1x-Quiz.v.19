...
public class Teacher_Second extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dialogbox = (RelativeLayout)findViewById(R.id.RelativeLayoutadd);
        MainScreen = (View) findViewById(R.id.drawer_layout);
        OK = (TextView)findViewById(R.id.OK);
        Cancel = (TextView)findViewById(R.id.cancel);
        Question = (EditText)findViewById(R.id.getQuestion);
        rg = (RadioGroup)findViewById(R.id.RadioGroup);
        rootView = (LinearLayout)findViewById(R.id.Questions);  //Elements are to be added here
        Add = (TextView)findViewById(R.id.Addoptions);
        DisplayQuestion = (RelativeLayout)findViewById(R.id.display_question);
        rg1 = (RadioGroup)findViewById(R.id.RadioGroup1);
        ForDatabase = (Button)findViewById(R.id.AddtoDatabase);
        ...
        ForDatabase.setOnClickListener(new View.OnClickListener() {
            ...
            private void databaseaddFunc(int question) {
                ...
                for(int l = counterarray[question - 1]; l<counterarray[question];l++){
                    myref.child("Subject").child("Quiz").child("Question " + Integer.toString(question)).child("option " + Integer.toString(k)).setValue(options[l]);
                    k++;
                }
                myref.child("Subject").child("Quiz").child("Question " + Integer.toString(question)).child("ans").setValue(answer[question]);

                myref.child("Subject").child("question").setValue(QuestionList);
                myref.child("Subject").child("Quiz").child("Question " + Integer.toString(question)).child("Que").setValue(Questions[question]);
            }
        });
    ...
    private void Radiobuttonaddfunc() {
        ...
        editText.setHint("option "+  Integer.toString(QuestionCounter));
